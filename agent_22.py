...
# --- Configuration ---
LLM_API_KEY = os.environ.get("LLM_API_KEY", "AIzaSyAxWpP51mHHTgmbpTx5KzLaxB2bs5qR38c")  # Default API Key
...
"""
    ...
    ordered_keys = [
        ...
        "DQ_COLUMN_ASSESSMENT_TABLE", "DQ_NUMERIC_DIST_CHART",  # Changed from CSV to direct objects
        "DQ_CATEGORICAL_DIST_CHART", "DQ_CORRELATION_MATRIX_TABLE",
        "VISUALIZATION_CHART_OR_IMAGE", "PRIMARY_ANALYSIS_TABLE",  # AI Analysis results
    ...
    for key_index, key in enumerate(ordered_keys):
        ...
        title_map = {
            ...
            "DQ_NUMERIC_DIST_CHART": "Data Quality: Numeric Distribution",
            "DQ_CATEGORICAL_DIST_CHART": "Data Quality: Categorical Distribution",
        ...
        large_keys = [
            ...
            "DQ_COLUMN_ASSESSMENT_TABLE", "DQ_NUMERIC_DIST_CHART", "DQ_CATEGORICAL_DIST_CHART",
        ...
        elif key in ["DQ_NUMERIC_DIST_CHART", "DQ_CATEGORICAL_DIST_CHART"]:
            if isinstance(raw_content_obj, pd.DataFrame):
                item_content_html = _generate_chartjs_embed(raw_content_obj, f"dqChart{key_index}")
            else:  # Fallback
                item_content_html = _generate_html_paragraphs(str(raw_content_obj))
